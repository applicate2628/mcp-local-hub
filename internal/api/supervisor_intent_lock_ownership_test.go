...
var reviewedRawFlockOwners = map[string]int{
	...
	"internal/api/default_workspace_marker.go:func:ClearDefaultWorkspaceIfMatches": 1,
	...
	"internal/api/lock_release_ledger.go:func:lockLeafLedgered":                    1,
	"internal/api/lock_release_ledger.go:func:tryLockLeafLedgered":                 1,
