...
func (o *openCodeClient) restoreEntryFromBackupWithWriter(backupPath, name string, allowHubEntry bool, writer WriteConfigFileFunc) error {
	...
	return o.restoreEntryFromBytes(backupData, name, allowHubEntry, writer)
}
...
func (o *openCodeClient) restoreEntryFromBytes(backupData []byte, name string, allowHubEntry bool, writer WriteConfigFileFunc) error {
	...
	if allowHubEntry {
		...
		if liveMap, rerr := o.readJSON(); rerr == nil {
